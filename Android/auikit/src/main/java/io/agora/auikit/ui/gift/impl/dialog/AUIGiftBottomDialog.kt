...
import io.agora.auikit.databinding.VoiceDialogGiftLayoutBinding
...
class AUIGiftBottomDialog constructor(
    context: Context,
    data:List<AUIGiftTabEntity>
) : AUIBaseSheetDialog<VoiceDialogGiftLayoutBinding>() {
    ...
    fun initView() {
        binding?.viewPager?.adapter = object :
            ...
            override fun createFragment(position: Int): Fragment {
                val fragment = LiveGiftListFragment(mContext, mGiftList, tapList[position])
    ...
    fun setDialogActionListener(listener:ActionListener){
