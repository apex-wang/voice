...
public interface IAUiMicSeatService extends IAUiCommonService<IAUiMicSeatService.AUiMicSeatRespDelegate>{
    int ERROR_USER_HAS_ON_SEAT = 100; // 自己已经上麦
    int ERROR_USER_HAS_OUT_SEAT = 101; // 自己没在麦上
    int ERROR_SEAT_HAS_SOMEONE = 102; // 麦位上有人
    int ERROR_SEAT_LOCKED = 103; // 麦位被封禁
    int ERROR_SEAT_STATUS_UNAVAILABLE = 104; // 麦位状态不存在
