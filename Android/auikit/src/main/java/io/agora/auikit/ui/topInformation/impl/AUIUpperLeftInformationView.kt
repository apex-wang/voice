...
import io.agora.auikit.databinding.AuiUpperLeftInformationLayoutBinding
...
class AUIUpperLeftInformationView : ConstraintLayout, AUITopInformationView {
    private val aRoomViewBinding = AuiUpperLeftInformationLayoutBinding.inflate(LayoutInflater.from(context))
    private var aUpperLeftListener: AUIUpperLeftActionListener? = null
    ...
    override fun setUpperLeftActionListener(listener: AUIUpperLeftActionListener?) {
