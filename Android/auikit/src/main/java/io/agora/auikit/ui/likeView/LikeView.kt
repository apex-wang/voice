...
class LikeView : AppCompatImageView {
    private var mHeartResId: Int = R.drawable.voice_icon_like_1
    private var mHeartBorderResId: Int = R.drawable.voice_icon_like_2
