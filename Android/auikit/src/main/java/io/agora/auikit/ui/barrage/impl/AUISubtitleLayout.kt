...
import io.agora.auikit.ui.barrage.listener.AUIStatusChangeListener

class AUISubtitleLayout : RelativeLayout, AUIStatusChangeListener {
    //View宽度
    private var mWidth = 0
    //View高度
    private var mHeight = 0
    private lateinit var mBaseLayout: ConstraintLayout
    lateinit var mContent: AUISubtitleView
